...
class Category(models.Model):
    ...
    subcategories = models.ManyToManyField(
        SubCategory, "self", blank=True, symmetrical=False, verbose_name="Subcategories"
    )
...
class Review(models.Model):
    ...
    author = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="Author"
    )
    ...
    product = models.ForeignKey(
        Product, blank=True, null=True, related_name="reviews", on_delete=models.CASCADE
    )
...
class Sale(models.Model):
    ...
    salePrice = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Sale Price"
    )
    ...
    )  # Conexiune la produsul vândut
    product_image = models.ForeignKey(
        Image, on_delete=models.CASCADE, verbose_name="Product Image"
    )
